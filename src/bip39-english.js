// The official BIP39 English wordlist (2048 words), from
// github.com/bitcoin/bips/blob/master/bip-0039/english.txt. The list is in the
// public domain. Used only by Seed Guard (src/seed-guard.js), in the browser
// and on the server; never fetched. SHA-256 of english.txt (the words joined
// with "\n", plus a final "\n"):
