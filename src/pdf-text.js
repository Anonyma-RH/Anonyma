...
// { text, pages, hidden } from a PDF's bytes (an ArrayBuffer or typed array).
// `withDetails` also lists the document properties Clean Uploads reports.
export async function pdfText(data, withDetails = false) {
